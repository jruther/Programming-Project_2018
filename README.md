...
The data set was formulated by a British statistician and biologist, [Ronald Fisher](https://en.wikipedia.org/wiki/Ronald_Fisher) and published in his paper *The use of multiple measurements in taxonomic problems*, in 1936. ![Sir Ronald Fisher](https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/R._A._Fischer.jpg/220px-R._A._Fischer.jpg) The actual data was collected by [Edgar Anderson](https://en.wikipedia.org/wiki/Edgar_Anderson), along the shore of the Saint Lawrence River in Quebec, Canada.
